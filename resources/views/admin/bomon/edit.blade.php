...
@section('page_title', 'Chỉnh Sửa Bộ Môn')
    ...
    <div class="col-lg-7">
        <div class="card card-premium">
            <div class="card-header-premium">
                <i class="fa-solid fa-pen-to-square text-primary me-2"></i>Chỉnh Sửa Bộ Môn: {{ $bomon->TenBoMon }}
            </div>
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('bomon.update', $bomon->MaBoMon) }}">
                    ...
                    @method('PUT')
                    <div class="mb-3">
                        <label class="form-label fw-bold">Mã Bộ Môn</label>
                        <input type="text" class="form-control bg-light" value="{{ $bomon->MaBoMon }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Tên Bộ Môn <span class="text-danger">*</span></label>
                        <input type="text" name="TenBoMon" class="form-control" value="{{ old('TenBoMon', $bomon->TenBoMon) }}" required>
                    </div>
                    <div class="mb-4">
