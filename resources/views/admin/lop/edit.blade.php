...
@section('page_title', 'Chỉnh Sửa Lớp Học')
    ...
    <div class="col-lg-7">
        <div class="card card-premium">
            <div class="card-header-premium">
                <i class="fa-solid fa-pen-to-square text-primary me-2"></i>Chỉnh Sửa Lớp: {{ $lop->TenLop }}
            </div>
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('lop.update', $lop->MaLop) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="KhoaHoc" class="form-control" value="{{ old('KhoaHoc', $lop->KhoaHoc) }}" required>
                    </div>
