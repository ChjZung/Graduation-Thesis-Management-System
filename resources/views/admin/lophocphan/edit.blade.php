...
@section('page_title', 'Chỉnh Sửa Lớp Học Phần')
    ...
    <div class="col-md-8">
        <div class="card card-premium">
            <div class="card-header-premium d-flex justify-content-between align-items-center">
                <span><i class="fa-solid fa-pen-to-square text-primary me-2"></i>Chỉnh Sửa Lớp Học Phần #{{ $lopHocPhan->MaLopHP }}</span>
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.lophocphan.update', $lopHocPhan->MaLopHP) }}" method="POST">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-3">
                        <label class="form-label fw-bold">Tên Lớp Học Phần <span class="text-danger">*</span></label>
                        <input type="text" name="TenLopHP" class="form-control" value="{{ old('TenLopHP', $lopHocPhan->TenLopHP) }}" required>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="MaMon" class="form-select" required>
                                ...
                                @foreach($monHocs as $m)
                                    <option value="{{ $m->MaMon }}" {{ old('MaMon', $lopHocPhan->MaMon) == $m->MaMon ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="MaGV" class="form-select" required>
                                ...
                                @foreach($giangViens as $gv)
                                    <option value="{{ $gv->MaGV }}" {{ old('MaGV', $lopHocPhan->MaGV) == $gv->MaGV ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="SiSoToiDa" class="form-control" value="{{ old('SiSoToiDa', $lopHocPhan->SiSoToiDa) }}" min="1" max="200" required>
                        </div>

                        <div class="col-md-3 mb-3">
                            <label class="form-label fw-bold">Trạng Thái <span class="text-danger">*</span></label>
                            <select name="TrangThai" class="form-select" required>
                                <option value="Đang mở" {{ old('TrangThai', $lopHocPhan->TrangThai) == 'Đang mở' ? 'selected' : '' }}>Đang mở</option>
                                <option value="Đã đóng" {{ old('TrangThai', $lopHocPhan->TrangThai) == 'Đã đóng' ? 'selected' : '' }}>Đã đóng</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-4 rounded-pill"><i class="fa-solid fa-save me-1"></i>Cập Nhật</button>
                    </div>
                </form>
            </div>
        </div>
